odoo.define('theme_neon.snippet_builder',function(require) {
    'use strict';
    ...
    options.registry.summernote_embeded = options.Class.extend({
        xmlDependencies: ['/theme_neon/static/src/xml/website_snippet_builder.xml'],
        start: function () {
            var self = this;
        ...
        select_snippet: function(type, value) {
            ...
            if(type == false || type == 'click'){
                var dialog = new Dialog(self, {
                    size: 'extra-large',
                    title: 'Neon Snippet Builder',
                    $content: QWeb.render("theme_neon.builder_block"),
